...
"""
1. Cree una funcion que reciba una letra y cuente cuantos
nombres hay con esa letra

2. Cree un programa que reciba una lista y una palabra y
verifique si ese elemento se repite en la lista
